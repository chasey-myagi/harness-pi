...
> 2026-05 更新：本文件保留的是早期 prior-art 审核记录；core kernel、hook dispatcher、plugins、controllers 和 first-party tools 已在 v0.1 readiness scope 中落地。当前剩余迁移 blocker 以 [roadmap](roadmap.md) 为准。
